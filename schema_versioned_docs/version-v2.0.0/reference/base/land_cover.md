...
| `geometry` | [`geometry`](../system/geometric.md) | Shape of the covered land area, which may be a polygon or multi-polygon.<br/><br/>*Allowed geometry types: MultiPolygon, Polygon* |
| `theme` | `"base"` | |
| `type` | `"land_cover"` | |
...
| `sources[0].update_time` | `2024-11-07T00:00:00+00:00` |
