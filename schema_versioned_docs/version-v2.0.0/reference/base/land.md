...
| `geometry` | [`geometry`](../system/geometric.md) | Geometry of the land feature, which may be a point, line string, polygon, or multi-polygon.<br/><br/>*Allowed geometry types: LineString, MultiPolygon, Point, Polygon* |
| `theme` | `"base"` | |
| `type` | `"land"` | |
...
| `class` | [`LandClass`](types/land_class.md) | |
| `subtype` | [`LandSubtype`](types/land_subtype.md) | |
