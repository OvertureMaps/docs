...
| `geometry` | [`geometry`](../system/geometric.md) | Shape of the underwater area, which may be a polygon or multi-polygon.<br/><br/>*Allowed geometry types: MultiPolygon, Polygon* |
| `theme` | `"base"` | |
| `type` | `"bathymetry"` | |
