...
| `geometry` | [`geometry`](../system/geometric.md) | Geometry of the water feature, which may be a point, line string, polygon, or multi-polygon.<br/><br/>*Allowed geometry types: LineString, MultiPolygon, Point, Polygon* |
| `theme` | `"base"` | |
| `type` | `"water"` | |
...
| `class` | [`WaterClass`](types/water_class.md) | |
| `subtype` | [`WaterSubtype`](types/water_subtype.md) | |
...
| `sources[0].update_time` | `2024-02-11T05:52:05+00:00` |
