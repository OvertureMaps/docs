...
| :--------------------------------------------------------------: |
|             _H3 coverage map of Overture addresses_              |
...
And now we're excited to include another new source of open data for addresses in the U.S. Previously, Overture pulled all address data
...
| ![TomTom roads](/img/blog/roads-tomtom-october.png) |
| :-------------------------------------------------: |
|    _Roads from TomTom in Italy and Saudi Arabia_    |
