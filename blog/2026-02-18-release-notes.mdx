...
## What's new?
In this release we added a new `admin_level` property to the Divisions schema to represent a division’s position in its country’s hierarchy. We also updated our [places guide](/guides/places/) with more information about our new taxonomy, including mappings across the `basic_category`, `taxonomy`, and `categories` properties.
