...
#### Amazon S3
```
s3://overturemaps-us-west-2/release/2025-09-23.1
```

#### Microsoft Azure
```
wasbs://release@overturemapswestus2.blob.core.windows.net/2025-09-23.1
```

Shortly after this release went public, we found a bug in the new GERS ID generation for base features. This patch fixes it by restoring August's base data in place of September's.
