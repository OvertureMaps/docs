...
- changed the default value of the `operating_status` property to null instead of open
- updates to default confidence values of existing providers


### Transportation

- OSM Cut-Off Date: `2026-05-10`

| Dataset | Feature Count | Length (km) |
|---|---|---|
| OpenStreetMap | 748,646,121 | 94,033,027 |
| TomTom | 	8,875,123 | 1,537,447 |
...
|---|---|---|---|
| TomTom | segment | 116,650 | 1.33% |
| OpenStreetMap | connector | 2,209,065 | 0.54% |
| OpenStreetMap | segment | 1,290,304 | 0.38% |

##### Length Changes

| Subtype | Diff (km) | Diff (%) |
|---|---|---|
| road | 267,644.99 | 0.29% |
| rail | 4,446.43 | 0.16% |
| water | 2,750.14 | 0.47% |
