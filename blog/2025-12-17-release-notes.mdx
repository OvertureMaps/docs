...
**The `2025-12-17.0` release of Overture data and `v1.15.0` of the Overture schema are now available.** The datasets and release artifacts are available as GeoParquet files stored on both AWS and Azure. There are [breaking changes](/release-calendar) in this release. 
