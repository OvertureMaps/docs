...
During our final QA process we caught an issue in the `2025-08-20.0` release: all Microsoft ML buildings were incorrectly assigned `"is_underground": true`. We decided to make the release public with the bug and issue a patch to the data. Expect `2025-08-20.1` to be released shortly.

![Schema docs describing is_underground](/img/is_underground.jpg)
