...
The datasets are available as Parquet files stored on AWS and Azure. The release paths are:

```
Azure: wasbs://release@overturemapswestus2.blob.core.windows.net/2024-07-22.0

AWS: s3://overturemaps-us-west-2/release/2024-07-22.0
```
...
We are now including with each release a GERS changelog that captures feature changes by Overture ID. The changelog is available as Parquet files &mdash; partitioned by theme, type, and change type &mdash; at the following locations:

```
Azure: wasbs://changelog@overturemapswestus2.blob.core.windows.net/2024-07-22.0

AWS: s3://overturemaps-us-west-2/changelog/2024-07-22.0
```
