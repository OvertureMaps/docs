...
- made incremental updates from OSM, based on Daylight v1.49
...
- resolved {Some building and building_part polygons have identical geometries}(https://github.com/OvertureMaps/tf-buildings/issues/130)
[Add classification for bridge structures to schema. Action Item](https://github.com/OvertureMaps/tf-buildings/issues/144)
