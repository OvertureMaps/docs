...
With each data release, Overture generates a [GERS](../) changelog that captures changes in the data tied to the unique IDs for each feature. This information can be used to guide decisions about data matching, better understand data stability, and help detect data errors. 

The GERS changelog is available as Parquet files &mdash; partitioned by theme, type, and change type &mdash; at following locations:
...
- removed: feature with this ID was present in the previous release but not in this release.
