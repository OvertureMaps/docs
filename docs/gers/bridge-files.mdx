...
| `between` | array | the portion of the [normalized length](/schema/concepts/by-theme/transportation/linear-referencing) of the GERS feature the dataset way takes (0 to 1) |
