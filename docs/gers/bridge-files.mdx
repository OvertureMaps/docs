...
:::note
Currently, Overture only provides bridge files for these source datasets: Esri Community, geoBoundaries, Instituto Geográfico Nacional (España)Maps, Meta, Microsoft, OpenStreetMap, PinMeTo
:::
...
The Parquet schema includes the following properties:
