...
An Overture ID is 128 bits and 32 characters. In this example, you can see five unique IDs for building features from the July 2024 data release. [The IDs for the building feature type are registered to GERS](stability). 
