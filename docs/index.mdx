...
## Dig Deeper 
- Read a high-level overview of the [schema](https://docs.overturemaps.org/themes/) for each data theme. 
- Consult the technical [reference](https://docs.overturemaps.org/reference) for schema details.
- Learn about the [simple feature model](https://docs.overturemaps.org/overview/feature-model/) we use to describe Overture data.
