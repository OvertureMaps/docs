...
| Date              | Data version                                                                   | Schema version                                                           |
| ----------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| 23 September 2026 | [`2026-09-23.0`](https://docs.overturemaps.org/blog/2026/09/23/release-notes/) | [`v2.0.0`](https://github.com/OvertureMaps/schema/releases/tag/v2.0.0) |
