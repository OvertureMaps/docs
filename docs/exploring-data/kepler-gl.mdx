...
---
 ...
 Follow the [instructions for running Overture's set-up queries](./../../accessing-data/cloud-services) in Amazon Athena. Then you can run this in the query console:
