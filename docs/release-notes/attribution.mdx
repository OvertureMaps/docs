...
Publications and research reports based on Overture Maps data may choose to use the following citation, including the date the data were accessed: `Overture Maps Foundation, overturemaps.org` 
...
Some of the data sources we use to create our datasets do require attribution, according to their license. See below for more information.
