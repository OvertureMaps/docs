...
The Overture Maps Foundation does not require text attribution or an OMF logo on maps, visualizations, and graphics created with our datasets. If you would like to add text attribution, we suggest: 

`© Overture Maps Foundation` 

Some of the data sources we use in Overture Maps datasets do require attribution, according to their licenses. See below for more information.
