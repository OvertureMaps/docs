...
Overture maintains just over 205 million address point entities. The address theme is derived from a variety of sources, mostly distributed through [OpenAddresses](https://openaddresses.io/).
...
<details>
	<summary>List of all properties in the addresses GeoParquet files</summary>
