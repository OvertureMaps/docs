...
| ![Overture places theme coverage](/img/places/places-coverage-h3-nov.png) |
|:--:|
| *Overture places data, November 2025* |

| Sources | License | feature count, November 2025 |
| --- | --- | --- |
| AllThePlaces, Overture | CC0-1.0              | 1,545,943      |
| Foursquare, Overture   | Apache-2.0           | 6,065,888      |
| Krick, Overture        | CDLA-Permissive-2.0  | 3,199         |
| Microsoft, Overture    | CDLA-Permissive-2.0  | 5,707,560      |
| PinMeTo, Overture      | CDLA-Permissive-2.0  | 125,147       |
| RenderSEO, Overture    | CDLA-Permissive-2.0  | 4,850         |
| meta, Overture         | CDLA-Permissive-2.0  | 58,675,469     |
