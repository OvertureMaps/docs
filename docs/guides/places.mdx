...
| ![Overture places theme coverage](/img/places/places-coverage-h3-oct.png) |
|:--:|
| *Overture places data, October 2025* |

| sources (ordered) | feature count, October 2025 |
| --- | --- |
| Foursquare, Overture                                        | 6,192,142      |
| Krick, Overture                                             | 3,193         |
| Microsoft, Overture                                         | 5,723,539      |
| PinMeTo, Overture                                           | 125,377       |
| meta, Overture                                              | 5,9457,529     |
