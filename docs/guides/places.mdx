---
title: Places
description: 66M places and points of interest around the world
---
...
| Source |  Feature count, April 2025 release |
| -------------------------- | --------------------- |
| Meta | 57,562,784 |
| Microsoft | 5,572,735 |
| Microsoft & Meta | 2,908,951 |
