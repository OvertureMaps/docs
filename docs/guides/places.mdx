---
title: Places
description: 53M places and points of interest around the world
---
...
| Primary source |  Feature count, February 2025 release |
| -------------------------- | --------------------- |
| Meta | ~56.5 million |
| Microsoft | ~5.7 million |
