...
| ![Overture places theme coverage](/img/places/places-coverage-h3-aug.png) |
|:--:|
| *Overture places data, August 2025* |

| source | feature count, August 2025 |
| --- | --- |
| meta | 56,659,810 |
| Microsoft | 5,369,523 |
| meta & Microsoft | 3,169,090 |
| Microsoft & PinMeTo | 74,744 |
| PinMeTo | 19,132 |
| meta, Microsoft & PinMeTo | 33,899 |
| Krick & Microsoft | 6,355 |
| meta & PinMeTo | 3,707 |
| Krick | 3,140 |
| Krick, meta & Microsoft | 2,717 |
| Krick & meta | 706 |
