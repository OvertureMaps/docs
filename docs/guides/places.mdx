...
To acquire the entire places dataset, the parquets can be directly downloaded from the S3 or Azure locations above but these alternate methods may be better depending on your use case.
...
These examples use data attributes in the address, category, and confidence scores columns to filter the data in useful ways using DuckDB.
<Tabs>
