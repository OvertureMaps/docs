...
| ![Overture places theme coverage](/img/places/places-coverage-h3-dec.png) |
|:--:|
| *Overture places data, December 2025* |

| Sources | License | feature count, December 2025 |
| --- | --- | --- |
| AllThePlaces, Overture | CC0-1.0              | 1,578,702      |
| Foursquare, Overture   | Apache-2.0           | 6,005,339      |
| Krick, Overture        | CDLA-Permissive-2.0  | 3,202         |
| Microsoft, Overture    | CDLA-Permissive-2.0  | 5,679,072      |
| PinMeTo, Overture      | CDLA-Permissive-2.0  | 125,480       |
| RenderSEO, Overture    | CDLA-Permissive-2.0  | 4,844         |
| meta, Overture         | CDLA-Permissive-2.0  | 59,020,602     |
