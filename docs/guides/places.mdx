---
title: Places
description: 66.5M places and points of interest around the world
---
...
| Source |  Feature count, March 2025 release |
| -------------------------- | --------------------- |
| Meta | 58,177,213 |
| Microsoft | 5,542,373 |
| Microsoft & Meta | 2,878,513 |
