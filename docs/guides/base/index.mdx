...
#### Water 
Water features represent ocean and inland water bodies. In Overture data releases, water features are sourced from OpenStreetMap. There are two main categories of water feature: ocean and inland water bodies. ter`**: physical representations of inland and ocean marine surfaces; translates natural and waterway tags from OpenStreetMap.



### Column definitions 

The column definitions for the all types in the base theme are generated from the schema and live in the schema reference:
