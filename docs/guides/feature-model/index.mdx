...
- **Global Entity Reference System (GERS) IDs**: the Global Entity Reference System is responsible for handling persistent identification across entities in the Overture corpus.
