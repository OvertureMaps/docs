...
[This Overture doc](https://docs.overturemaps.org/getting-data/duckdb/#installation) describes the installation process in more detail.

## How to access the data <a name="how_to_access_the_data"></a>

Documentation and install links for DuckDB, below:
