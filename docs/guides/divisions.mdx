...
<details>
	<summary>Counts, per subtype, of the division feature type</summary>
...
<details>
	<summary>Counts, per subtype, of the division_area feature type</summary>
...
<details>
	<summary>Counts, per subtype, of the division_boundary feature type</summary>
...
As of the July 2024 release, there are 24 columns in the divisions GeoParquet files. Each column is a property in the data. 
