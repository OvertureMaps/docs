...
|--------|------|-------------------|--------|
| [OpenStreetMap](//osm.org) | Community-contributed | 1 | ~669 Million |
...
| [Microsoft](https://github.com/microsoft/GlobalMLBuildingFootprints) | ML-derived roofprints | 6 | ~712 Million |
