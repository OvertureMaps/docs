...
|--------|------|-------------------|--------|
| [OpenStreetMap](//osm.org) | Community-contributed | 1 | ~680 Million |
...
| [Microsoft](https://github.com/microsoft/GlobalMLBuildingFootprints) | ML-derived roofprints | 6 | ~708 Million |
