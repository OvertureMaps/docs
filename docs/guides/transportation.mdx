...
| subtype | class | subclass | feature count, December 2025 |
| --- | --- | --- | --- |
| rail    | funicular      | NULL           | 1,317                        |
| rail    | light_rail     | NULL           | 16,561                       |
| rail    | monorail       | NULL           | 3,044                        |
| rail    | narrow_gauge   | NULL           | 30,090                       |
| rail    | standard_gauge | NULL           | 1,445,737                    |
| rail    | subway         | NULL           | 53,799                       |
| rail    | tram           | NULL           | 59,323                       |
| rail    | unknown        | NULL           | 383,731                      |
| road    | bridleway      | NULL           | 101,066                      |
| road    | cycleway       | cycle_crossing | 60,986                       |
| road    | cycleway       | NULL           | 1,300,448                    |
| road    | footway        | crosswalk      | 2,322,730                    |
| road    | footway        | sidewalk       | 3,776,992                    |
| road    | footway        | NULL           | 16,426,150                   |
| road    | living_street  | NULL           | 3,368,321                    |
| road    | motorway       | link           | 642,885                      |
| road    | motorway       | NULL           | 435,127                      |
| road    | path           | NULL           | 13,749,801                   |
| road    | pedestrian     | NULL           | 469,388                      |
| road    | primary        | link           | 495,638                      |
| road    | primary        | NULL           | 6,740,621                    |
| road    | residential    | NULL           | 126,430,738                  |
| road    | secondary      | link           | 392,130                      |
| road    | secondary      | NULL           | 10,795,915                   |
| road    | service        | alley          | 1,771,004                    |
| road    | service        | driveway       | 17,166,177                   |
| road    | service        | parking_aisle  | 6,455,870                    |
| road    | service        | NULL           | 33,547,995                   |
| road    | steps          | NULL           | 1,924,755                    |
| road    | tertiary       | link           | 300,177                      |
| road    | tertiary       | NULL           | 20,051,853                   |
| road    | track          | NULL           | 25,607,487                   |
| road    | trunk          | link           | 560,895                      |
| road    | trunk          | NULL           | 3,495,095                    |
| road    | unclassified   | NULL           | 29,781,035                   |
| road    | unknown        | NULL           | 6,876,828                    |
| water   | NULL           | NULL           | 28,433                       |
...
Since a GERS ID will no longer be unique with this output, the resulting data will have two additional columns: `start_lr` and `end_lr` which are [linear references](/schema/concepts/by-theme/transportation/linear-referencing) (0.0 = start, 1.0 = end) describing which section of the original feature this new segment comes from.
