...
| subtype | class | subclass | feature count, January 2026 |
| --- | --- | --- | --- |
| rail    | funicular      | NULL           | 1,323         |
| rail    | light_rail     | NULL           | 16,821        |
| rail    | monorail       | NULL           | 3,040         |
| rail    | narrow_gauge   | NULL           | 30,171        |
| rail    | standard_gauge | NULL           | 1,453,426      |
| rail    | subway         | NULL           | 53,947        |
| rail    | tram           | NULL           | 59,218        |
| rail    | unknown        | NULL           | 385,877       |
| road    | bridleway      | NULL           | 101,128       |
| road    | cycleway       | cycle_crossing | 62,180        |
| road    | cycleway       | NULL           | 1,309,693      |
| road    | footway        | crosswalk      | 2,360,767      |
| road    | footway        | sidewalk       | 3,840,408      |
| road    | footway        | NULL           | 16,598,243     |
| road    | living_street  | NULL           | 3,384,707      |
| road    | motorway       | link           | 646,178       |
| road    | motorway       | NULL           | 437,350       |
| road    | path           | NULL           | 13,827,014     |
| road    | pedestrian     | NULL           | 470,547       |
| road    | primary        | link           | 498,404       |
| road    | primary        | NULL           | 6,767,490      |
| road    | residential    | NULL           | 126,617,119    |
| road    | secondary      | link           | 394,035       |
| road    | secondary      | NULL           | 10,827,808     |
| road    | service        | alley          | 1,800,079      |
| road    | service        | driveway       | 17,343,078     |
| road    | service        | parking_aisle  | 6,493,526      |
| road    | service        | NULL           | 33,733,647     |
| road    | steps          | NULL           | 1,941,665      |
| road    | tertiary       | link           | 302,150       |
| road    | tertiary       | NULL           | 20,128,259     |
| road    | track          | NULL           | 25,734,052     |
| road    | trunk          | link           | 564,611       |
| road    | trunk          | NULL           | 3,502,731      |
| road    | unclassified   | NULL           | 29,827,462     |
| road    | unknown        | NULL           | 7,227,050      |
| water   | NULL           | NULL           | 28,521        |
