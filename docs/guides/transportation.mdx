...
| subtype | class | subclass | feature count, September 2025 |
| --- | --- | --- | --- |
| rail | funicular | | 1,309 |
| rail | light_rail | | 16,302 |
| rail | monorail | | 3,037 |
| rail | narrow_gauge | | 31,105 |
| rail | standard_gauge | | 1,432,742 |
| rail | subway | | 52,834 |
| rail | tram | | 59,075 |
| rail | unknown | | 378,647 |
| road | bridleway | | 100,550 |
| road | cycleway | cycle_crossing | 57,957 |
| road | cycleway | | 1,279,784 |
| road | footway | crosswalk | 2,219,681 |
| road | footway | sidewalk | 3,595,350 |
| road | footway | | 16,025,515 |
| road | living_street | | 3,332,042 |
| road | motorway | link | 640,561 |
| road | motorway | | 433,073 |
| road | path | | 13,523,391 |
| road | pedestrian | | 465,722 |
| road | primary | link | 491,060 |
| road | primary | | 6,698,107 |
| road | residential | | 125,885,875 |
| road | secondary | link | 389,359 |
| road | secondary | | 10,737,084 |
| road | service | alley | 1,716,773 |
| road | service | driveway | 16,761,777 |
| road | service | parking_aisle | 6,355,124 |
| road | service | | 33,109,690 |
| road | steps | | 1,878,101 |
| road | tertiary | link | 297,561 |
| road | tertiary | | 19,881,087 |
| road | track | | 25,289,639 |
| road | trunk | link | 554,871 |
| road | trunk | | 3,456,718 |
| road | unclassified | | 29,648,979 |
| road | unknown | | 1,710,480 |
| water | | | 28,327 |
...
The [transportation-spitter tool](https://github.com/OvertureMaps/transportation-splitter) transforms Overture road data into simpler sub segments. It will optionally divide features at each connector point and at each change of a scoped based property, depending on configuration. Depending on your needs and map stack, the resulting dataset may be easier to manipulate than the original Overture data as each segment will only have connections at either end and have one set of properties for its entire length.
