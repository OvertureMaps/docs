...
The [connector](//docs.overturemaps.org/schema/reference/transportation/connector) feature type
...
The [segment](//docs.overturemaps.org/schema/reference/transportation/segment) feature type carries
...
[lane directionality](/guides/transportation/roads#lane-directionality) to indicate what travel
...
segments, see the page on [roads](/guides/transportation/roads).
...
[Global Entity Reference System](/guides/gers) (GERS) IDs assigned to segments. In
...
east and west. As a result, the [GERS](/guides/gers) IDs of the north-south road
...
at greater length in the page on [scoped properties](/guides/feature-model/scoping-rules).
...
stability, ultimately resulting in more precise and stable [GERS](/guides/gers) IDs and
