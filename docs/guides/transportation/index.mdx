...
The rest of this page covers the feature types and subtypes in the transportation theme, describes the dataset and how to access it, and points to tools and libraries for working with the data. The deeper topics are covered in the rest of the guide:
...
The column definitions for the properties in the transportation theme are generated from the schema and live in the schema reference:

- [segment](/schema/reference/transportation/segment/)
- [connector](/schema/reference/transportation/connector/)
