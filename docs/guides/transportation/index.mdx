...
| subtype | class | subclass | feature count, September 2026 |
| --- | --- | --- | --- |
| rail    | funicular      | NULL           | 1,386         |
| rail    | light_rail     | NULL           | 17,187        |
| rail    | monorail       | NULL           | 3,149         |
| rail    | narrow_gauge   | NULL           | 31,309        |
| rail    | standard_gauge | NULL           | 1,478,398     |
| rail    | subway         | NULL           | 56,852        |
| rail    | tram           | NULL           | 59,263        |
| rail    | unknown        | NULL           | 398,416       |
| road    | bridleway      | NULL           | 103,867       |
| road    | cycleway       | cycle_crossing | 71,047        |
| road    | cycleway       | NULL           | 1,380,383     |
| road    | footway        | crosswalk      | 2,627,180     |
| road    | footway        | sidewalk       | 4,288,979     |
| road    | footway        | NULL           | 17,856,986    |
| road    | living_street  | NULL           | 3,477,033     |
| road    | motorway       | link           | 671,002       |
| road    | motorway       | NULL           | 454,676       |
| road    | path           | NULL           | 14,373,963    |
| road    | pedestrian     | NULL           | 480,353       |
| road    | primary        | link           | 512,449       |
| road    | primary        | NULL           | 6,950,179     |
| road    | residential    | NULL           | 128,444,839   |
| road    | secondary      | link           | 405,348       |
| road    | secondary      | NULL           | 11,029,944    |
| road    | service        | alley          | 1,942,090     |
| road    | service        | driveway       | 18,472,933    |
| road    | service        | parking_aisle  | 6,750,438     |
| road    | service        | NULL           | 34,991,687    |
| road    | steps          | NULL           | 2,073,143     |
| road    | tertiary       | link           | 309,013       |
| road    | tertiary       | NULL           | 20,557,347    |
| road    | track          | NULL           | 26,586,118    |
| road    | trunk          | link           | 588,446       |
| road    | trunk          | NULL           | 3,596,482     |
| road    | unclassified   | NULL           | 30,233,197    |
| road    | unknown        | NULL           | 10,750,443    |
| water   | NULL           | NULL           | 29,185        |
