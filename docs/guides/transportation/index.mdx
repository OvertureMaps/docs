...
| subtype | class | subclass | feature count, June 2026 |
| --- | --- | --- | --- |
| rail    | funicular      | NULL           | 1,383         |
| rail    | light_rail     | NULL           | 16,823        |
| rail    | monorail       | NULL           | 3,109         |
| rail    | narrow_gauge   | NULL           | 31,112        |
| rail    | standard_gauge | NULL           | 1,469,738      |
| rail    | subway         | NULL           | 55,714        |
| rail    | tram           | NULL           | 59,553        |
| rail    | unknown        | NULL           | 393,223       |
| road    | bridleway      | NULL           | 103,142       |
| road    | cycleway       | cycle_crossing | 67,798        |
| road    | cycleway       | NULL           | 1,352,090      |
| road    | footway        | crosswalk      | 2,526,042      |
| road    | footway        | sidewalk       | 4,120,442      |
| road    | footway        | NULL           | 17,366,428     |
| road    | living_street  | NULL           | 3,443,575      |
| road    | motorway       | link           | 665,200       |
| road    | motorway       | NULL           | 451,463       |
| road    | path           | NULL           | 14,157,317     |
| road    | pedestrian     | NULL           | 476,772       |
| road    | primary        | link           | 510,633       |
| road    | primary        | NULL           | 6,896,317      |
| road    | residential    | NULL           | 127,674,078    |
| road    | secondary      | link           | 402,893       |
| road    | secondary      | NULL           | 10,971,405     |
| road    | service        | alley          | 1,883,540      |
| road    | service        | driveway       | 18,020,070     |
| road    | service        | parking_aisle  | 6,646,923      |
| road    | service        | NULL           | 34,529,135     |
| road    | steps          | NULL           | 2,017,514      |
| road    | tertiary       | link           | 307,417       |
| road    | tertiary       | NULL           | 20,385,380     |
| road    | track          | NULL           | 26,249,791     |
| road    | trunk          | link           | 581,126       |
| road    | trunk          | NULL           | 3,559,850      |
| road    | unclassified   | NULL           | 30,098,037     |
| road    | unknown        | NULL           | 8,817,676      |
| water   | NULL           | NULL           | 28,870        |
