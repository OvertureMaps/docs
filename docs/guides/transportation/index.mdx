...
| subtype | class | subclass | feature count, May 2026 |
| --- | --- | --- | --- |
| rail    | funicular      | NULL           | 1,373         |
| rail    | light_rail     | NULL           | 16,883        |
| rail    | monorail       | NULL           | 3,103         |
| rail    | narrow_gauge   | NULL           | 31,154        |
| rail    | standard_gauge | NULL           | 1,467,754      |
| rail    | subway         | NULL           | 55,642        |
| rail    | tram           | NULL           | 59,490        |
| rail    | unknown        | NULL           | 392,988       |
| road    | bridleway      | NULL           | 102,913       |
| road    | cycleway       | cycle_crossing | 67,051        |
| road    | cycleway       | NULL           | 1,342,254      |
| road    | footway        | crosswalk      | 2,501,112      |
| road    | footway        | sidewalk       | 4,075,848      |
| road    | footway        | NULL           | 17,251,963     |
| road    | living_street  | NULL           | 3,435,239      |
| road    | motorway       | link           | 650,692       |
| road    | motorway       | NULL           | 440,523       |
| road    | path           | NULL           | 14,109,570     |
| road    | pedestrian     | NULL           | 475,726       |
| road    | primary        | link           | 507,809       |
| road    | primary        | NULL           | 6,875,018      |
| road    | residential    | NULL           | 127,377,479    |
| road    | secondary      | link           | 400,947       |
| road    | secondary      | NULL           | 10,939,520     |
| road    | service        | alley          | 1,875,956      |
| road    | service        | driveway       | 17,934,963     |
| road    | service        | parking_aisle  | 6,625,446      |
| road    | service        | NULL           | 34,405,506     |
| road    | steps          | NULL           | 2,004,937      |
| road    | tertiary       | link           | 306,008       |
| road    | tertiary       | NULL           | 20,328,426     |
| road    | track          | NULL           | 26,177,656     |
| road    | trunk          | link           | 573,824       |
| road    | trunk          | NULL           | 3,538,465      |
| road    | unclassified   | NULL           | 30,053,556     |
| road    | unknown        | NULL           | 9,111,791      |
| water   | NULL           | NULL           | 28,847        |
