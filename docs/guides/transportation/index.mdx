...
| subtype | class | subclass | feature count, February 2026 |
| --- | --- | --- | --- |
| rail    | funicular      | NULL           | 1,334         |
| rail    | light_rail     | NULL           | 16,780        |
| rail    | monorail       | NULL           | 3,074         |
| rail    | narrow_gauge   | NULL           | 30,315        |
| rail    | standard_gauge | NULL           | 1,458,563     |
| rail    | subway         | NULL           | 54,414        |
| rail    | tram           | NULL           | 59,375        |
| rail    | unknown        | NULL           | 388,555       |
| road    | bridleway      | NULL           | 101,680       |
| road    | cycleway       | cycle_crossing | 63,645        |
| road    | cycleway       | NULL           | 1,318,148     |
| road    | footway        | crosswalk      | 2,394,456     |
| road    | footway        | sidewalk       | 3,900,688     |
| road    | footway        | NULL           | 16,781,574    |
| road    | living_street  | NULL           | 3,393,192     |
| road    | motorway       | link           | 647,835       |
| road    | motorway       | NULL           | 439,832       |
| road    | path           | NULL           | 13,891,866    |
| road    | pedestrian     | NULL           | 472,000       |
| road    | primary        | link           | 501,104       |
| road    | primary        | NULL           | 6,797,594     |
| road    | residential    | NULL           | 126,809,961   |
| road    | secondary      | link           | 396,563       |
| road    | secondary      | NULL           | 10,852,223    |
| road    | service        | alley          | 1,829,727     |
| road    | service        | driveway       | 17,531,932    |
| road    | service        | parking_aisle  | 6,532,119     |
| road    | service        | NULL           | 33,938,532    |
| road    | steps          | NULL           | 1,958,366     |
| road    | tertiary       | link           | 304,152       |
| road    | tertiary       | NULL           | 20,195,922    |
| road    | track          | NULL           | 25,860,663    |
| road    | trunk          | link           | 567,918       |
| road    | trunk          | NULL           | 3,509,117     |
| road    | unclassified   | NULL           | 29,885,974    |
| road    | unknown        | NULL           | 8,787,375     |
| water   | NULL           | NULL           | 28,583        |
