...
stability and ultimately feature ID stability. Read more on the [shape and connectivity](/guides/transportation/shape-connectivity) page.
...
Read more about these concepts on the [scoped and rule-based properties](/guides/feature-model/scoping-rules) page.
...
are currently the most developed part of the `transportation` schema. Read more about roads on the [roads](/guides/transportation/roads) page.
...
and rule-based properties. Read more about the travel modes concept and how travel modes interact with other scoping properties on the [travel modes](/guides/transportation/travel-modes) page.

- [Explore the schema for the connector feature type](https://docs.overturemaps.org/schema/transportation/connector).
- [Explore the schema for the segment feature type](https://docs.overturemaps.org/schema/transportation/segment).
