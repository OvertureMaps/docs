...
| ![Overture places theme coverage](/img/places/places-coverage-h3-may.png) |
|:--:|
| *Overture places data, May 2026* |

| Sources | License | feature count, May 2026 |
| --- | --- | --- |
| AllThePlaces, Overture | CC0-1.0              | 1,731,796    |
| BrightQuery, Overture  | CDLA-Permissive-2.0  | 473,190      |
| DAC, Overture          | CDLA-Permissive-2.0  | 164,987      |
| Foursquare, Overture   | Apache-2.0           | 6,712,933    |
| Krick, Overture        | CDLA-Permissive-2.0  | 16,563       |
| Microsoft, Overture    | CDLA-Permissive-2.0  | 7,405,625    |
| PinMeTo, Overture      | CDLA-Permissive-2.0  | 136,547      |
| RenderSEO, Overture    | CDLA-Permissive-2.0  | 5,396        |
| meta, Overture         | CDLA-Permissive-2.0  | 59,195,082   |
