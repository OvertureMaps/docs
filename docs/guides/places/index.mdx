...
| ![Overture places theme coverage](/img/places/places-coverage-h3-apr.png) |
|:--:|
| *Overture places data, April 2026* |

| Sources | License | feature count, April 2026 |
| --- | --- | --- |
| AllThePlaces, Overture | CC0-1.0              | 1,749,242    |
| Foursquare, Overture   | Apache-2.0           | 6,749,057    |
| DAC, Overture          | CDLA-Permissive-2.0  | 166,108      |
| Krick, Overture        | CDLA-Permissive-2.0  | 2,791        |
| Microsoft, Overture    | CDLA-Permissive-2.0  | 7,261,643    |
| PinMeTo, Overture      | CDLA-Permissive-2.0  | 147,902      |
| RenderSEO, Overture    | CDLA-Permissive-2.0  | 5,740        |
| meta, Overture         | CDLA-Permissive-2.0  | 59,413,511   |
