...
- **[Tools and libraries](#tools-and-libraries)**: Tools from Overture and the wider ecosystem, including the interactive [Taxonomy Explorer](./taxonomy-browser).
...
- **[Taxonomy Explorer](./taxonomy-browser)**: An interactive tool for exploring and comparing releases of the Overture Places category taxonomy hierarchy.
