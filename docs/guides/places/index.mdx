...
The Overture places theme has one feature type, called `place`, and contains more than 75 million point representations of real-world entities: schools, businesses, hospitals, religious organizations, landmarks, mountain peaks, and much more.
...
All Overture data, including places data, is distributed as GeoParquet, a column-based data structure. Below you'll find a table with column-by-column descriptions of the properties in the place feature type. 

<details>
    <summary>Column definitions for the Places theme</summary>
<div>
