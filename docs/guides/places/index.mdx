...
| --- | --- | --- |
| AllThePlaces, Overture | CC0-1.0              | 1,651,532    |
| Foursquare, Overture   | Apache-2.0           | 6,503,660    |
| DAC, Overture          | CDLA-Permissive-2.0  | 153,642      |
| Krick, Overture        | CDLA-Permissive-2.0  | 3,188        |
| Microsoft, Overture    | CDLA-Permissive-2.0  | 5,492,871    |
| PinMeTo, Overture      | CDLA-Permissive-2.0  | 130,234      |
| RenderSEO, Overture    | CDLA-Permissive-2.0  | 4,685        |
| meta, Overture         | CDLA-Permissive-2.0  | 58,843,409   |
