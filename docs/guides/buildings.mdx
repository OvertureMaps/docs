...
| -------------------------- | --------------------- | -------------------------- | ----------- |
| [OpenStreetMap](//osm.org) | Community-contributed | 1 | ~637 Million |
| [Esri Community Maps](https://communitymaps.arcgis.com/home) | Community-contributed | 2| ~15 Million |
| [Instituto Geográfico Nacional (España)](https://www.ign.es/) | National dataset | 3 | ~13 Million |
| [Google Open Buildings](https://sites.research.google/open-buildings/)| ML-derived roofprints<br />  (&gt;90% precision) | 4 | ~350 Million |
| [Microsoft](https://github.com/microsoft/GlobalMLBuildingFootprints) |ML-derived roofprints  | 5 | ~738 Million |
| [Google Open Buildings](https://sites.research.google/open-buildings/)| ML-derived roofprints<br />  (&lt;90% precision) | 6 |~650 Million |
| [Buildings in East Asian Countries](https://zenodo.org/records/8174931)| ML-derived roofprints<br />  | 7 |~228 Million |
