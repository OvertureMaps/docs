...
| -------------------------- | --------------------- | -------------------------- | ----------- |
| [OpenStreetMap](//osm.org) | Community-contributed | 1                          |~620 Million  |
...
| [Microsoft](https://github.com/microsoft/GlobalMLBuildingFootprints) |ML-derived roofprints  | 4|~736 Million |
