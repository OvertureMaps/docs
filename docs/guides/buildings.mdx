---
title: Working with Overture's buildings data
---
...
- [Explore the schema reference for the building feature type](/reference/buildings/building).
- [Explore the schema reference for the building part feature type](/reference/buildings/building_part).
