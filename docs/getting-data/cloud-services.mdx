...
Add Overture as a cross-account data source using [these instructions](https://docs.aws.amazon.com/athena/latest/ug/data-sources-glue-cross-account.html). The Catalog ID is `913550007193` and the permissions policy required for querying is listed below.

<details>
  <summary>IAM Policy for Overture Glue catalog access</summary>
  <div>
```json
{
  "Version": "2012-10-17",
