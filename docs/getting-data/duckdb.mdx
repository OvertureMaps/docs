...
[DuckDB](https://duckdb.org/) is powerful analytics tool that allows you to query remote files and download only the data you want. [DuckDB 1.1.0](https://duckdb.org/2024/09/09/announcing-duckdb-110.html) now supports reading and writing geoparquet.
