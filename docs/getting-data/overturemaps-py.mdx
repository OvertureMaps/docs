...
Overture's Python command-line tool helps you download data within a region of interest and converts it to several common geospatial file formats. [This example](/blog/2024/05/16/land-cover/) shows how to use the tool to download Overture's land cover data in a Jupyter notebook. 
...
- Contribute to overturemaps-py. 
- Visualize your data in QGIS or kepler. 
- Make a map.
- Consult one of our guides to learn more about the data and see examples of more advanced queries.
- Check out our Made by the Overture Community page. 
- Dig into the Overture schema. 
