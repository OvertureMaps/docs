...
Overture distributes its five data themes &mdash; [base](/guides/base), [buildings](/guides/buildings), [admins/divisions](/guides/divisions), [places](/guides/places), and [transportation](/guides/transportation) &mdash; as [GeoParquet](https://guide.cloudnativegeo.org/geoparquet/) files. **The total size of the latest release is ~440 GB.** The GeoParquet files for each dataset are freely available on both Amazon S3 and Microsoft Azure Blob Storage at these locations:
