...
After installation, you'll find a new toolbar for accessing Overture data and other cloud-native geospatial datasets, from [Source Cooperative](https://source.coop/) and [OpenStreetMap](https://openstreetmap.us/our-work/layercake/). Most installations handle the DuckDB automatically, though some systems may require additional setup, see [installation instructions](https://github.com/cholmes/qgis_plugin_gpq_downloader/blob/main/README.md#installation). Note: To save the data as GeoParquet files, your QGIS installation needs GDAL version 3.5 or higher.
