...
We need to clean the data and unpack values from the nested arrays in the attribute fields. This will make it easier for us to inspect and display the metadata in QGIS.
