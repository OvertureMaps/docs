---
title: Overture + PMTiles + Maplibre
---
...
The places data theme represents business and points of interest in the real world. Read more about the places data schema in the [documentation](/docs/guides/places).
...
The [divisions theme](/docs/guides/divisions) contains named administrative units (countries, regions, counties, cities, etc.) and their boundaries. To add labels for populated places to the map, we query the divisions theme to get the primary name for each locality.
