...
Not yet familiar with CARTO? [Sign up](https://www.carto.com/signup) for a 14-day free trial and start getting the most out of your spatial data!.
...
- Overture data in [Google BigQuery](https://docs.overturemaps.org/getting-data/bigquery/)
- Oveture data in [Snowflake](https://docs.overturemaps.org/getting-data/snowflake/)
- Overture data in [Databricks](https://docs.overturemaps.org/getting-data/databricks/)

Additionally, CARTO users have direct access to Overture Data from the Data Obseratory available in the platform. In order to access Overture Data from there, you just have to navigate to the Data Observatory section, search for Overture Data, and access the tables that you need in a matter of a few clicks. 


<img 
  src="../../static/img/examples/CARTO_DO.gif" 
  alt="Overture data from CARTO DO" 
  width="900" 
  height="auto" 
/>
...
<img 
  src="../../static/img/examples/CARTO_Workflows.gif" 
  alt="Example of CARTO Workflows with Overture data" 
  width="900" 
  height="auto" 
/>
...
<img 
  src="../../static/img/examples/CARTO_Builder.gif" 
  alt="Example of CARTO Builder with Overture data" 
  width="900" 
  height="auto" 
/>
...
- CARTO's [QGIS Plugin](https://docs.carto.com/data-and-analysis/carto-qgis-plugin) allows you to access, visualize, and edit spatial data from the leading cload data warehouses directly within QGIS. You can also use this plugin to access Overture data in QGIS via CARTO. 
