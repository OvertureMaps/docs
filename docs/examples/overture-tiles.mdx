...
[View 2024-07-22/places.pmtiles on pmtiles.io](https://pmtiles.io/?url=https%3A%2F%2Foverturemaps-tiles-us-west-2-beta.s3.amazonaws.com%2F2024-07-22%2Fplaces.pmtiles)
...
![explore.overturemaps.org](/img/overture-tiles-job-definitions.png)
  ...
  * Input the **Command** as a JSON list: `["2024-07-22.0","my-bucket","addresses"]`

    * The first item is the release version, including minor version: `2024-07-22.0`

    * The second item is the target bucket: `my-bucket`

    * The third item is the theme: `addresses`

  * Once the job is complete, the tileset will be available at `s3://BUCKET_NAME/RELEASE/THEME.pmtiles`.
