...
## Query the data in AWS Athena
 ...
 Follow the [instructions for running the set-up queries](./../../accessing-data/cloud-services) in Amazon Athena. Then you can run this in the Athena query console:
