...
In this example, we'll show you how to process and visualize Overture data in a Jupyter notebook using [Lonboard](https://developmentseed.org/lonboard/latest/). As in previous examples, we'll be using [GeoPandas](https://geopandas.org/en/stable/index.html) to handle the data. But instead of querying the data with DuckDB, we'll use the [Overture Python command-line tool](https://github.com/OvertureMaps/overturemaps-py), built with Lonboard integration in mind. 
