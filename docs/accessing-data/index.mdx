...
We _strongly recommend_ accessing the data in situ by querying it either [locally](locally) or via [cloud services](cloud-services). This allows you to download only the subset of data you want. However, it is also possible to download the geoparquet files directly:
