...
| `geometry` | [`geometry`](../system/primitive/geometry.md) | Position of the place. Places are point geometries.<br/>*Allowed geometry types: Point* |
| `theme` | `"places"` | |
| `type` | `"place"` | |
...
| `websites` | `list<`[`HttpUrl`](../pydantic/networks/http_url.md)`>` (optional) | The websites of the place.<br/>*Minimum length: 1*<br/>*All items must be unique. (`UniqueItemsConstraint`)* |
| `socials` | `list<`[`HttpUrl`](../pydantic/networks/http_url.md)`>` (optional) | The social media URLs of the place.<br/>*Minimum length: 1*<br/>*All items must be unique. (`UniqueItemsConstraint`)* |
| `emails` | `list<`[`EmailStr`](../pydantic/networks/email_str.md)`>` (optional) | The email addresses of the place.<br/>*Minimum length: 1*<br/>*All items must be unique. (`UniqueItemsConstraint`)* |
| `phones` | [`PhoneNumber`](../system/phone_number.md) (list, optional) | The phone numbers of the place.<br/>*Minimum length: 1*<br/>*All items must be unique. (`UniqueItemsConstraint`)* |
...
| `addresses[]` | `list<`[`Address`](types/address.md)`>` (optional) | The address or addresses of the place<br/>*Minimum length: 1* |
