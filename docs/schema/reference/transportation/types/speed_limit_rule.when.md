...
| -----: | :----: | ------------- |
| `heading` | [`Heading`](../../core/scoping/heading.md) (optional) | The heading, either forward or backward, that the containing SpeedLimitRule applies to.<br/><br/>*At least one of `heading`, `during`, `mode`, `using`, `recognized`, `vehicle` must be set* |
