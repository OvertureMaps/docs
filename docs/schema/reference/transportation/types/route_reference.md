...
| -----: | :----: | ------------- |
| `name` | [`StrippedString`](../../system/stripped_string.md) (optional) | Full name of the route<br/><br/>*Minimum length: 1* |
| `network` | [`StrippedString`](../../system/stripped_string.md) (optional) | Name of the highway system this route belongs to<br/><br/>*Minimum length: 1* |
