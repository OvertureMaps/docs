...
|-----:|:----:|-------------|
| `property` | [`JsonPointer`](../strings/json_pointer.md) | A JSON Pointer identifying the property (field) that this source information applies to.
...
| `license` | [`StrippedString`](../strings/stripped_string.md) (optional) | Source data license name.
...
| `confidence` | [`ConfidenceScore`](../core_types/confidence_score.md) (optional) | Confidence value from the source dataset.
