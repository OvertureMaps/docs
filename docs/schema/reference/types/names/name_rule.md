...
|-----:|:----:|-------------|
| `value` | [`StrippedString`](../strings/stripped_string.md) | The actual name value. |
| `variant` | [`NameVariant`](name_variant.md) | The name variant for this name rule. |
| `language` | [`LanguageTag`](../strings/language_tag.md) (optional) | The language in which the name `value` is specified, if known, as an IETF BCP 47
language tag. |
| `perspectives` | [`Perspectives`](../perspectives/perspectives.md) (optional) |  |
| `perspectives.mode` | [`PerspectiveMode`](../perspectives/perspective_mode.md) | Whether the perspective holder accepts or disputes this name. |
| `perspectives.countries` | [`CountryCodeAlpha2`](../strings/country_code_alpha2.md) (list) | Countries holding the given mode of perspective. |
